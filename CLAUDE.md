...
- `cloudflare.md` — Build chain, middleware entry, Server Action IP, Cache Components limits
- `coding-standards.md` — TypeScript strict, naming, imports, logging
- `code-quality.md` — Complexity limits, magic numbers, ESLint disable
- `content.md` — MDX vs TypeScript content strategy, frontmatter schema
- `conventions.md` — Hydration pitfalls, use-client boundary, route deletion steps
- `i18n.md` — next-intl usage, Cache Components compatibility
- `security.md` — API route skeleton, rate limit, CSP, input validation
- `testing.md` — Vitest/Playwright, mock system, selector priority
- `ui.md` — Component reuse, design tokens, Tailwind v4, shadcn/ui
