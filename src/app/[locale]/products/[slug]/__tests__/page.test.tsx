      ...
      return (
        <main className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div data-testid="product-gallery" data-title={product.title}>
              <img
            ...
            <div className="space-y-6">
              ...
              {hasCertifications && (
                ...
                >
                  {product.certifications!.map((cert: string) => (
                    <span key={cert} data-testid={`cert-${cert}`}>
                      {cert}
                    </span>
                  ))}
                </div>
              ...
              >
                ...
                {product.pdfUrl && (
                  <a href={product.pdfUrl} data-testid="download-pdf-link">
...
vi.mock("@/components/products", () => ({
  ProductCertifications: ({
    ...
    <div data-testid="product-certifications" data-title={title}>
  ...
  ProductGallery: ({ images, title }: { images: string[]; title: string }) => (
    <div data-testid="product-gallery" data-title={title}>
      {images.map((img, i) => (
        <img
          key={i}
          src={img}
  ...
  ProductSpecs: ({
    ...
    <div data-testid="product-specs" data-title={title}>
  ...
  ProductTradeInfo: ({
    ...
    <div data-testid="product-trade-info" data-title={title}>
      {Object.entries(props).map(([key, value]) => (
        <div key={key} data-testid={`trade-${key}`}>
  ...
  ProductActions: ({
    ...
    >
      ...
      {pdfHref && (
        <a href={pdfHref} data-testid="download-pdf-link">
          {downloadPdfLabel}
        </a>
      )}
    </div>
