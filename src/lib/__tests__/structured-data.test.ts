  ...
  beforeEach(() => {
    ...
    const mockT = vi.fn((key: string, options?: { defaultValue?: string }) => {
      const translations: Record<string, string> = {
        "organization.name": "Tianze Pipe",
        "organization.description":
          "Professional PVC conduit and PETG pneumatic tube manufacturer",
        "website.name": "Tianze Pipe",
        "website.description": "Professional pipe manufacturer",
        "breadcrumb.home": "Home",
        "breadcrumb.about": "About",
        "breadcrumb.contact": "Contact",
        "article.author": "Tianze Pipe",
        "product.brand": "Tianze Pipe",
        "faq.question1": "What is this platform?",
        "faq.answer1": "A professional pipe manufacturing platform",
        "business.name": "Tianze Pipe Industry",
        "business.address": "江苏省连云港市灌云县东王集工业集中区玉龙路6号",
  ...
  describe("generateLocalizedStructuredData - WebSite", () => {
    it("should generate valid website schema", async () => {
      ...
      expect(schema).toMatchObject({
        ...
        "@type": "WebSite",
        name: "Tianze Pipe",
        description: "Professional pipe manufacturer",
        url: "https://example.com",
        inLanguage: ["en", "zh"],
      });
