 ...
 */
// eslint-disable-next-line max-statements, complexity -- orchestration logic intentionally coordinates validation, routing, metrics, and summaries in one place
