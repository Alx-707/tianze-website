...
describe("ProductActions", () => {
  ...
  describe("PDF download button", () => {
    ...
    it("does not render PDF button when pdfHref is undefined", () => {
      render(
        <ProductActions {...defaultProps} downloadPdfLabel="Download PDF" />,
      );
  ...
  describe("sticky bar", () => {
    ...
    it("sticky bar shows product name", () => {
      render(<ProductActions {...defaultProps} productName="Widget Pro" />);
  ...
  describe("custom className", () => {
    it("applies custom className to main CTA container", () => {
      const { container } = render(
        <ProductActions {...defaultProps} className="custom-actions-class" />,
      );
  ...
  describe("edge cases", () => {
    ...
    it("handles very long product names", () => {
      ...
      render(<ProductActions {...defaultProps} productName={longName} />);
