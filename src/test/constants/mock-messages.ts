...
export const seoMessages = {
  ...
  keywords:
    "PVC conduit, PETG tube, pneumatic tube, pipe manufacturer, industrial pipes",
  pages: {
    home: {
      title: "Tianze Pipe - Professional Pipe Manufacturer",
      description:
        "Professional PVC conduit and PETG pneumatic tube manufacturer with ISO 9001:2015 certification.",
    },
    about: {
      title: "About Us - Tianze Pipe",
      description:
        "Learn about Tianze Pipe's mission to provide high-quality industrial pipe solutions.",
    },
    contact: {
      title: "Contact Us - Tianze Pipe",
      description:
        "Get in touch with our team for product inquiries and support.",
    },
    products: {
      title: "Products - Tianze Pipe",
      description:
        "Discover our range of PVC conduits and PETG pneumatic tubes for industrial applications.",
    },
    blog: {
      title: "Blog - Tianze Pipe",
      description: "Latest insights and updates from Tianze Pipe.",
    },
  },
} as const;
