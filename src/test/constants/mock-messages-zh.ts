...
export const seoMessages = {
  title: "天泽管业",
  description: "专业PVC管道与PETG气动传输管制造商",
  siteName: "天泽管业",
  keywords: "PVC管道, PETG管, 气动传输管, 管道制造商, 工业管道",
  pages: {
    home: {
      title: "天泽管业 - 专业管道制造商",
      description: "专业PVC管道与PETG气动传输管制造商，通过ISO 9001:2015认证。",
    },
    about: {
      title: "关于我们 - 天泽管业",
      description: "了解天泽管业为客户提供高品质工业管道解决方案的使命。",
    },
    contact: {
      title: "联系我们 - 天泽管业",
      description: "联系我们的团队获取产品咨询和技术支持。",
    },
    products: {
      title: "产品中心 - 天泽管业",
      description: "探索我们的PVC管道和PETG气动传输管系列产品。",
    },
    blog: {
      title: "新闻动态 - 天泽管业",
      description: "天泽管业最新资讯和行业动态。",
    },
  },
} as const;
