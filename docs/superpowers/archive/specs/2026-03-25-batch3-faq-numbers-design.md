...
FAQ content authored via `/cwf` workflow: `docs/cwf/faq/v1-final.md` (en) and `docs/cwf/faq/v1-zh-final.md` (zh). These files contain all 20 questions with full answers. During implementation, content is extracted into translation key structure described above.
...
- `/cwf` FAQ content already complete (docs/cwf/faq/v1-final.md + v1-zh-final.md)
