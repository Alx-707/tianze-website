...
**Spec reference:** `docs/superpowers/specs/2026-03-29-methodology-driven-framework-design.md`

**Key context files:**
- `.claude/product-marketing-context.md` -- existing product/audience/voice definitions
- `docs/design/system/sitemap.md` -- current site structure
- `docs/design/products/CATALOG-STRUCTURE.md` -- product catalog structure
