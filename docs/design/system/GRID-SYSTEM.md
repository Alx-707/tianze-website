...
> Reference: `docs/design/external/vercel-design-system/` (original Vercel specs — do not modify)
...
| File | Purpose |
|------|---------|
| `docs/design/external/vercel-design-system/README.md` | Vercel design system overview |
| `docs/design/external/vercel-design-system/layout.css` | Vercel grid CSS variables |
| `docs/design/external/vercel-design-system/components/Layout.tsx` | Vercel component reference |
