...
| 11 | `/contact` | `/contact/` | Implemented | Shared | Decision | **Partial** | Has contact form, email/phone, response expectations, business hours, FAQ (MOQ, lead time, payment, samples, OEM). Missing: business-line routing on form, factory address with map, factory visit invitation CTA |
