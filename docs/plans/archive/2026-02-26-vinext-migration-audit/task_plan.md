...
- 用户提供的文档路径 `docs/known-issues/phase6-api-worker-bundle-failure.md` 当时不存在；当前可对照的归档材料主要在 `docs/archive/migration/2026-03-16-cloudflare-bundle-phases/cloudflare_bundle_phase6.md`。
